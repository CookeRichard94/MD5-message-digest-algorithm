...
int main(int argc, char **argv)
{
  ...
  while ((c = getopt (argc, argv, "s:t:h:")) != -1)
  {
    switch(c){
      ...
      case 't':
        ...
        printf("The following is a list of test cases to run to ascertain that the correct hashing is occuring\n");
        printf("==============================================================================================\n");
        ...
        printf("Input: 'abcdefghijklmnopqrstuvwxyz'  Should produce output: c3fcd3d76192e4007dfb496cca67e13b \n");
        md5_hash_string((uint8_t *)"abcdefghijklmnopqrstuvwxyz");
        printf ("The Hash Output of this Input is: \n"); 
        digest=(uint8_t *)&a;
        printf("%2.2x%2.2x%2.2x%2.2x", digest[0], digest[1], digest[2], digest[3], a);
        digest=(uint8_t *)&b;
        ...
        printf("Input: 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'  Should produce output: d174ab98d277d9f5a5611c2c9f419d9f \n");
        md5_hash_string((uint8_t *)"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
        printf ("The Hash Output of this Input is: \n"); 
        digest=(uint8_t *)&a;
        printf("%2.2x%2.2x%2.2x%2.2x", digest[0], digest[1], digest[2], digest[3], a);
        digest=(uint8_t *)&b;
        ...
        printf("Input: '12345678901234567890123456789012345678901234567890123456789012345678901234567890'  Should produce output: 57edf4a22be3c955ac49da2e2107b67a \n");
        md5_hash_string((uint8_t *)"12345678901234567890123456789012345678901234567890123456789012345678901234567890");
        printf ("The Hash Output of this Input is: \n"); 
        digest=(uint8_t *)&a;
        printf("%2.2x%2.2x%2.2x%2.2x", digest[0], digest[1], digest[2], digest[3], a);
        digest=(uint8_t *)&b;
 ...
 /*
    ...
    md5_hash_string((uint8_t *)msg); //Had to cast msg to uint8_t as compiler was throwing an error
